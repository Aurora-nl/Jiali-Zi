...
function [Destination_position,Emax,Destination_fitness,Fit,Yfinal,sepresults,YYY]=SCAoptimum(s,XX,rt,upload)
...
for i=1:size(X,1)
    Objective_values(1,i)=FitnessFunNew(X(i,:),XX);
%     Objective_values(1,i)=FitnessFun(X(i,:),XX);
    if i==1
