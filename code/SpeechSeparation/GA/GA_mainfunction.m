function [W1,Emax,max_fitness,Fit,Yfinal,sepresults,YYY] = GA_mainfunction(s,X,rt,upload)
%%遗传参数设置
P=200;%初始种群大小
irange_l=-1; %问题解区间
irange_r=1;
...
%     [fitness,W]= m_FitnessNew(pop,P,X);
    [fitness,W]= m_Fitness(pop,P,X);
    time_max_fitness = min(fitness);
    ...
    mybestresult(1).postion(time,:)=W1(1,:);
end
